...
md:-translate-y-15.75 `]: isOpen
	...
	<p class="absolute -bottom-3 mx-auto text-center text-[10px] text-zinc-500 md:text-xs">
		unperformant <span class="star relative top-[0.75px]">*</span>
		<a class="hover:text-sky-500" href="https://x.com/emilkowalski_" target="_blank"
			>@emilkowalski_</a
		>
	</p>
</div>
